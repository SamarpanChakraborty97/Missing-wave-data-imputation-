...
for k in range(len(X_Train)):
    ...
    plt.savefig(f'Sample1_{k}.jpeg', bbox_inches='tight',pad_inches = 0)
    plt.close()
...
for k in range(len(X_Val)):
    ...
    plt.savefig(f'SampleVal1_{k}.jpeg', bbox_inches='tight',pad_inches = 0)
    plt.close()
...
class Optimization:
    ...
    def train(self, train_loader, val_loader, batch_size, n_epochs, n_features, output_dim):
        ...
        model_path = f'cnn_lstm_twoFreqs.pt'
